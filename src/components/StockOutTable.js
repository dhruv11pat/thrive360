          ...
          {activeTab === 'ai' && (
            <div className="bg-white shadow-md rounded-lg p-4">
              ...
              <div className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">AI Models Module</h3>
                <p className="text-gray-600 mb-4">Advanced machine learning models for supply chain optimization and forecasting.</p>
                <p className="text-gray-500">This module is under development. Coming soon.</p>
              </div>
            </div>
          )}
